...
SELECT * FROM user_form
LEFT JOIN like_form ON user_form.TELEGRAM_ID = like_form.OWNER_TELEGRAM_ID
AND like_form.LIKER_TELEGRAM_ID = ?
WHERE  like_form.ID IS NULL
